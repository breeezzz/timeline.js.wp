<?php
if(!class_exists('Timeline_WP_Post_Type')){
  class Timeline_WP_Post_Type{
    ...
    function meta_box_event_date_view(){
      ...
      <label id="label_start_date" for="_start_date"><span class="hide-start">Start </span>Date: </label>
...
<?php
    ...
    function save_timeline_meta_data(){
      global $post_id;
      if(get_post_type($post_id) !== 'timeline_wp'){
        return;
      }
